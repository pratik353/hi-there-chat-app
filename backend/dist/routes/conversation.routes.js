...
exports.conversationRouter.get("/user/:userId", userMiddleware_1.userMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.conversationRouter.get("/:id", userMiddleware_1.userMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.conversationRouter.post("/", userMiddleware_1.userMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.conversationRouter.put("/:id", userMiddleware_1.userMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const conversationId = req.params.id;
    const payload = req.body;
    try {
...
exports.conversationRouter.delete("/:id", userMiddleware_1.userMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const conversationId = req.params.id;
    try {
